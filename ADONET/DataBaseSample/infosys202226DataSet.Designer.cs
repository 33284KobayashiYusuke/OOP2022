...
namespace DataBaseSample.infosys202226DataSetTableAdapters {
    ...
    public partial class 社員TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBaseSample.Properties.Settings.Default.infosys202226ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT                      社員番号, 名前, 入社年月日, 給与, 社員番号 AS Expr1, 名前 AS Expr2, 入社年月" +
                "日, 給与\r\nFROM                         社員\r\nWHERE                       (給与 >= @valu" +
                "e)";
        ...
        public virtual int Fill(infosys202226DataSet.社員DataTable dataTable) {
        ...
        public virtual infosys202226DataSet.社員DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            infosys202226DataSet.社員DataTable dataTable = new infosys202226DataSet.社員DataTable();
        ...
        public virtual int FillBySalary(infosys202226DataSet.社員DataTable dataTable, global::System.Nullable<int> value) {
        ...
        public virtual infosys202226DataSet.社員DataTable GetDataBy(global::System.Nullable<int> value) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((value.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(value.Value));
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(infosys202226DataSet.社員DataTable dataTable) {
